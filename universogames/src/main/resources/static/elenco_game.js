$(document).ready(function() {
	...
	function getVideogames() {
		...
		$(".elenco").html('');
		$.get(`videogames/last/12/${npage}`, function(res) {
				...
				$(
					`<div class="col">
					   <div class="card shadow-sm">
					          <img src='${res[i].img}' alt="andreacacca" class="r_img1">
			           <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
					           <div class="btn-group">
					                <button type="button" class="btn btn-sm btn-outline-secondary button_dettaglio" data-id='${res[i].id}' onclick="document.location='videogame.html'">View</button>
				               </div>
				               <small class="text-muted">Media voti: ${res[i].sumVotes/res[i].numberVotes}</small>
				         </div>
			          </div>
			        </div>
